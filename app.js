$(document).ready(function () {
  ...
  function renderDespesas() {
      ...
      for (var i = 0; i < despesas.length; i++) {
          ...
          var pagoChecked = despesa.pago ? 'checked' : ''; // Adicione esta linha
          ...
          var row = '<tr>' +
              ...
              '<input type="checkbox" class="pago-checkbox" data-index="' + i + '" data-content="Marcar como pago" data-position="top center" ' + pagoChecked + '>' + // Modifique esta linha
              '<label></label>' +
              '</div>' +
              '</td>' +
